  ...
  return (
    <div className='p-4 bg-slate-100'>
      <Helmet>
                ...
                <link rel="canonical" href="/Mentionslegales" />
      </Helmet>
      <section>
...
Informations clients : Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données personnelles susceptibles d’être détenues par https://wendybaqueauteurederomans.netlify.app/ pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.
...
<h2 className='text-blue-700 font-bold m-2 p-2'>1. Présentation du site internet.</h2>
En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet https://wendybaqueauteurederomans.netlify.app/ l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi:

Propriétaire : Wendy Baqué – 37340 Ambillou
Responsable publication : Wendy Baqué – wendybaque.auteur@gmail.com

Le responsable publication est une personne physique ou une personne morale.
Webmaster : Wendy Baqué – wendybaque.auteur@gmail.com
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>2. Conditions générales d’utilisation du site et des services proposés.</h2>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>3. Description des services fournis.</h2>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>4. Limitations contractuelles sur les données techniques.</h2>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>5. Propriété intellectuelle et contrefaçons.</h2>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>6. Limitations de responsabilité.</h2>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>7. Gestion des données personnelles.</h2>
Le Client est informé des réglementations concernant la communication marketing, la loi du 21 Juin 2014 pour la confiance dans l’Economie Numérique, la Loi Informatique et Liberté du 06 Août 2004 ainsi que du Règlement Général sur la Protection des Données (RGPD : n° 2016-679).
</section>
<section>
<h3 className='text-blue-700 m-1 p-1'>7.1 Responsables de la collecte des données personnelles</h3>
...
<section>
<h3 className='text-blue-700 m-1 p-1'>7.2 Finalité des données collectées</h3>
...
<section>
<h3 className='text-blue-700 m-1 p-1'>7.3 Droit d’accès, de rectification et d’opposition</h3>
...
droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui https://wendybaqueauteurederomans.netlify.app/ devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné
Dès que https://wendybaqueauteurederomans.netlify.app/ a connaissance du décès d’un Utilisateur et à défaut d’instructions de sa part, https://wendybaqueauteurederomans.netlify.app/ s’engage à détruire ses données, sauf si leur conservation s’avère nécessaire à des fins probatoires ou pour répondre à une obligation légale.

Si l’Utilisateur souhaite savoir comment https://wendybaqueauteurederomans.netlify.app/ utilise ses Données Personnelles, demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter https://wendybaqueauteurederomans.netlify.app/ par écrit à l’adresse suivante :

Wendy Baqué – DPO, Wendy Baqué
37340 Ambillou
...
<section>
<h3 className='text-blue-700 m-1 p-1'>7.4 Non-communication des données personnelles</h3>
...
https://wendybaqueauteurederomans.netlify.app/ s’engage à prendre toutes les précautions nécessaires afin de préserver la sécurité des Informations et notamment qu’elles ne soient pas communiquées à des personnes non autorisées. Cependant, si un incident impactant l’intégrité ou la confidentialité des Informations du Client est portée à la connaissance de https://wendybaqueauteurederomans.netlify.app/, celle-ci devra dans les meilleurs délais informer le Client et lui communiquer les mesures de corrections prises. Par ailleurs https://wendybaqueauteurederomans.netlify.app/ ne collecte aucune « données sensibles ».
...
<section>
<h3 className='text-blue-700 m-1 p-1'>7.5 Types de données collectées</h3>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>8. Notification d’incident </h2>
...
Aucune information personnelle de l'utilisateur du site https://wendybaqueauteurederomans.netlify.app/ n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de https://wendybaqueauteurederomans.netlify.app/ et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site https://wendybaqueauteurederomans.netlify.app/.
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>9. Liens hypertextes « cookies » et balises (“tags”) internet</h2>
...
<section></section>
<h3 className='text-blue-700 m-1 p-1'>9.1. « COOKIES »</h3>
Un « cookie » est un petit fichier d’information envoyé sur le navigateur de l’Utilisateur et enregistré au sein du terminal de l’Utilisateur (ex : ordinateur, smartphone), (ci-après « Cookies »). Ce fichier comprend des informations telles que le nom de domaine de l’Utilisateur, le fournisseur d’accès Internet de l’Utilisateur, le système d’exploitation de l’Utilisateur, ainsi que la date et l’heure d’accès. Les Cookies ne risquent en aucun cas d’endommager le terminal de l’Utilisateur.

https://wendybaqueauteurederomans.netlify.app/ est susceptible de traiter les informations de l’Utilisateur concernant sa visite du Site, telles que les pages consultées, les recherches effectuées. Ces informations permettent à https://wendybaqueauteurederomans.netlify.app/ d’améliorer le contenu du Site, de la navigation de l’Utilisateur.

Les Cookies facilitant la navigation et/ou la fourniture des services proposés par le Site, l’Utilisateur peut configurer son navigateur pour qu’il lui permette de décider s’il souhaite ou non les accepter de manière à ce que des Cookies soient enregistrés dans le terminal ou, au contraire, qu’ils soient rejetés, soit systématiquement, soit selon leur émetteur. L’Utilisateur peut également configurer son logiciel de navigation de manière à ce que l’acceptation ou le refus des Cookies lui soient proposés ponctuellement, avant qu’un Cookie soit susceptible d’être enregistré dans son terminal. https://wendybaqueauteurederomans.netlify.app/ informe l’Utilisateur que, dans ce cas, il se peut que les fonctionnalités de son logiciel de navigation ne soient pas toutes disponibles.

Si l’Utilisateur refuse l’enregistrement de Cookies dans son terminal ou son navigateur, ou si l’Utilisateur supprime ceux qui y sont enregistrés, l’Utilisateur est informé que sa navigation et son expérience sur le Site peuvent être limitées. Cela pourrait également être le cas lorsque https://wendybaqueauteurederomans.netlify.app/ ou l’un de ses prestataires ne peut pas reconnaître, à des fins de compatibilité technique, le type de navigateur utilisé par le terminal, les paramètres de langue et d’affichage ou le pays depuis lequel le terminal semble connecté à Internet.

Le cas échéant, https://wendybaqueauteurederomans.netlify.app/ décline toute responsabilité pour les conséquences liées au fonctionnement dégradé du Site et des services éventuellement proposés par https://wendybaqueauteurederomans.netlify.app/, résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour https://wendybaqueauteurederomans.netlify.app/ d’enregistrer ou de consulter les Cookies nécessaires à leur fonctionnement du fait du choix de l’Utilisateur. Pour la gestion des Cookies et des choix de l’Utilisateur, la configuration de chaque navigateur est différente. Elle est décrite dans le menu d’aide du navigateur, qui permettra de savoir de quelle manière l’Utilisateur peut modifier ses souhaits en matière de Cookies.

À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière de Cookies. https://wendybaqueauteurederomans.netlify.app/ pourra en outre faire appel aux services de prestataires externes pour l’aider à recueillir et traiter les informations décrites dans cette section.
...
<section>
<h3 className='text-blue-700 m-1 p-1'>Article 9.2. BALISES (“TAGS”) INTERNET</h3>
...
<section>
<h2 className='text-blue-700 font-bold m-2 p-2'>10. Droit applicable et attribution de juridiction.</h2>
