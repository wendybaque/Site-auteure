    ...
    <div className="bg-bg m-10 p-10">
      ...
      <div className="lg:flex lg:flex-row">
        <div className="flex flex-col m-2 p-2 lg:w-1/2">
          ...
          <h3 className="m-2 p-2 font-bold ">Genre : roman feel-good</h3>
          <p className="m-2 p-2 italic font-bold">
      ...
      <section id="testimonials">
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-x-2 m-2 p-2">
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                "J'ai beaucoup aimé ce personnage, sa sensibilité, ses doutes,
                le voir évoluer et l'accompagner, d'une certaine manière, sur
                son chemin à la recherche du bonheur, entre rires et larmes. La
                fleur de l'âge, ce sont deux âmes qui se croisent, se
                comprennent et se font du bien. "
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
                    src="https://m.media-amazon.com/images/I/41e2MG0aGxL._SX195_.jpg"
                    alt="couverture La fleur de l'âge"
                    class="object-cover object-center w-full h-full"
                  />
                </div>
                <h5 class="font-bold font-josefin">Marjorie</h5>
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                " La plume de Wendy est tout simplement belle et addictive.
                J'aime que dans chaque nouveau livre, elle fasse des allusions à
                ses œuvres déjà sorties et qu'il y ait toujours un lien entre
                elles. Elle a un talent incroyable et aime aborder des sujets
                pas évidents ce qui donne toujours de merveilleux résultats. Ici
                aussi dans La fleur de l'âge, on passe par tout un tas
                d'émotions : de la tristesse à la peur, parfois un peu de joie
                aussi et une certaine euphorie presque lorsque Benjamin prend sa
                vie en main. Le partage, l'entraide, la maladie et la fin de vie
                sont les principales idées de cette histoire et elles sont
                terriblement bien traitées."
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                " Ce livre est très émotif. C’est un moment d’une vie que
                personne ne veut vivre. J’ai été très émue par la relation de
                Benjamin et Marcelle. On peut se demander comment un jeune homme
                de 30 ans peut tomber sous le charme d’une vielle dame de 80
                ans. Mais oui, c’est possible et Wendy Baqué vous le prouve dans
                ce très beau roman. Je vous recommande ce roman une merveilleuse
                histoire."
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                ...
                <h5 class="font-bold font-josefin">Gaëlle</h5>
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                "Beaucoup de thèmes importants sont abordés dans cette histoire,
                mais ils le sont toujours de manière positive, même s'ils sont
                abordés dans la réalité de la vie du quotidien. Ils laissent
                leur place à l'espoir d'une évolution, d'une remise en question
                vers une vie meilleure, d'une acceptation de soi et des autres
                Cette histoire nous montre qu'à tout âge, tous les rêves sont
                permis, que les rencontres de la vie sont déterminantes et
                peuvent nous faire changer de cap vers un avenir meilleur"
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
                ...
                <h5 class="font-bold font-josefin">Françoise</h5>
                <p class="text-sm text-gray-600">
                  La vie en livres de Françoise
                </p>
              </div>
            </div>
          </div>
