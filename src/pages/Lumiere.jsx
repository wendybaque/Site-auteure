    ...
    <div className="bg-bg m-10 p-10">
      ...
      <div className="lg:flex lg:flex-row">
        <div className="flex flex-col m-2 p-2 lg:w-1/2">
          <Reveal>
            <h2 className="text-3xl font-bold text-secondary font-josefin">
      ...
      <section id="testimonials">
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-x-2 m-2 p-2">
            ...
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
                    src="https://www.babelio.com/couv/CVT_Les-dangers-de-la-lumiere_8495.jpg"
                    alt="couverture les dangers de la lumière"
                    class="object-cover object-center w-full h-full"
                  />
                </div>
                <h5 class="font-bold font-josefin">Patricia</h5>
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                "Ecrire et partager une histoire qui se déroule dans les années
                80 était un pari risqué, mais réussi avec justesse et
                originalité par Wendy. Elle se démarque encore une fois des
                clichés du genre et sort des sentiers battus en nous proposant
                un roman hors du commun ! Son style est toujours là, inimitable,
                percutant et incisif, mais surtout réaliste et rempli d'émotions
                qu'elle décrit très bien. C'est comme si on y était !"
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
                ...
                <h5 class="font-bold font-josefin">Judicaël</h5>
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                "Une histoire poignante, émouvante, encourageant à réaliser ces
                rêves quelque soit la difficulté. Wendy Baqué à su comme à son
                habitude poser des mots et des situations durs avec une fluidité
                qui rend la lecture de ces écrits additif. Dans ce livre vous
                plongez dans l'univers des strass, des déboires, de la
                maladie,de l'indifférence et des préjugés mais vous trouverez
                également une fille au caractère bien trempé qui même si elle
                est paumé, va tout faire pour se relever, accomplir ce qu'elle
                peut et devenir qui elle veut être vraiment.""
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                  <img
                ...
                <h5 class="font-bold font-josefin">Marie</h5>
          ...
          <div class="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
            <div class="mb-2">
              <p class="mb-2 text-center text-gray-600 font-bold">
                "J'ai été attirée par la couverture et le résumé, mais je ne
                pensais pas être autant prise par l'histoire. J'ai fait la
                tournée avec les personnages, ils m'ont complètement emportée.
                L'histoire est géniale, on replonge dans les années 80-90 avec
                la musique qui va bien et le langage... Bravo à l'auteure et
                merci pour ce roman."
              </p>
              <div class="flex flex-col items-center justify-center">
                <div class="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                ...
                <h5 class="font-bold font-josefin">Emilie</h5>
                <p class="text-sm text-gray-600">Lectrice</p>
              </div>
            </div>
          </div>
