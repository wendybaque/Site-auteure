    ...
    <div className="bg-bg lg:m-10 p-6">
      ...
      >
        <div className="flex items-center mb-3">
          ...
          <p className="ml-2 text-sm font-medium dark:text-white">4,3 sur 5</p>
        </div>
        ...
        <div className="flex justify-center w-full items-center mt-4">
          ...
          <span className="text-sm font-medium dark:text-blue-500">74%</span>
        </div>
        <div className="flex justify-center w-full items-center mt-4">
          <span className="text-sm font-medium dark:text-blue-500">
            4 <StarIcon />
        ...
        <div className="flex justify-center w-full items-center mt-4">
          ...
          <span className="text-sm font-medium dark:text-blue-500">3%</span>
        </div>
        <div className="flex justify-center w-full items-center mt-4">
          <span className="text-sm font-medium dark:text-blue-500">
            2 <StarIcon />
        ...
        <div className="flex justify-center w-full items-center mt-4">
          ...
          <span className="text-sm font-medium  dark:text-blue-500">9%</span>
        </div>
      </section>
