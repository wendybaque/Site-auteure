  ...
  return (
    <div className="lg:flex lg:flex-row m-2 p-2">
      <div className="lg:w-3/5 md:w-full sm:w-full m-2 p-2">
        <Reveal>
          <h2 className='text-3xl font-bold text-secondary font-yeseva'>Inoubliable symphonie</h2>
        </Reveal>
...
<a href="/Inoubliablesymphonie" alt="page les dangers de la lumière"><button className="hover:animate-bounce m-2 p-2">En savoir plus</button></a>
      </div>
