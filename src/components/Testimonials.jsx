    ...
    <div className="m-10 p-10 bg-bg">
      ...
      <div className="flex flex-col w-full max-w-sm rounded-lg shadow-lg bg-primary transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex flex-col content-center justify-center justify-items-center px-5 pb-5">
          <h5 className="text-l font-josefin tracking-tight p-4 dark:text-white">
            ...
            transpercera les âmes les plus endurcies. Elle nous transmet de très
            beaux messages avec justesse, humour et sensibilité. "
          </h5>
      ...
      <div className="flex flex-col w-full max-w-sm rounded-lg shadow-lg bg-primary transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden dark:bg-gray-800 dark:border-gray-700">
        ...
        >
          <img
            className="pb-6 rounded-lg items-center"
            src="https://drive.google.com/file/d/1Yp8kyo2u8zNIxfpfcFOPNnCVxQgzZqy9/view?usp=share_link"
      ...
      <div className="lg:grid lg:grid-cols-4 lg:gap-x-2 m-2 p-2">
        <div className="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
          <div className="mb-2">
            <p className="mb-2 text-center text-gray-600 font-bold">
              " Ce livre est clairement un chef-d'œuvre. Qu'on l'aime ou pas, il
              restera dans notre tête et dans notre cœur. De part son sujet déjà
              : une histoire interdite, un sujet encore tabou dans la société et
              pour beaucoup de monde et par toutes les questions qu'on est amené
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="w-12 h-12 overflow-hidden bg-gray-100 border-2 border-indigo-100 rounded-full">
                <img
                  src="https://i0.wp.com/www.plumesdemimieditions.fr/wp-content/uploads/122945414_1617147968458845_4965187562443510254_n.png?fit=1420%2C2250&ssl=1"
                  alt="img"
                  className="object-cover object-center w-full h-full"
                />
              </div>
              <h5 className="font-bold text-secondary font-josefin">Aurore</h5>
              <p className="text-sm text-gray-600">Les lectures d'Aurore</p>
            </div>
          </div>
        </div>
        <div className="p-4 text-gray-800 rounded-lg shadow-md bg-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 overflow-hidden">
          <div className="mb-2">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <h5 className="font-bold text-secondary font-josefin">Marine</h5>
              <p className="text-sm text-gray-600">Lectrice</p>
            </div>
          </div>
        </div>
      </div>
