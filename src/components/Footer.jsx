...
function Footer() {
  return (
    <div className="flex flex-row justify-between p-6 font-bold bg-slate-100">
      ...
      <p className=""><a href="/Mentionslegales" alt="Mentions légales" target="_blank" rel="noreferrer" className="hover:text-blue-700 hover:font-bold underline underline-offset-1">Mentions Légales</a></p>
    </div>
  );
}
