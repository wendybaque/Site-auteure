    ...
    <div>
      <main className="flex flex-row">
        <div className="flex flex-col align-center justify-center content-center p-2 m-2 basis-1/4">
                ...
                <a href="/Apropos" alt="about path"><button className="flex justify-self-center content-center	 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-bold rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">A propos de Wendy Baqué</button></a>
                <a href="https://wendybaqueauteur.wixsite.com/website" alt="blog path" target="_blank" rel="noreferrer"><button type="button" className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-bold rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Mon blog de chroniqueuse littéraire</button></a>
          </div>
